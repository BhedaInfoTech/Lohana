...
{
	if (hoteltriffpricedetailsid == null || hoteltriffpricedetailsid == "" || hoteltriffpricedetailsid == undefined)
	{
		hoteltriffpricedetailsid = 0;
	}
    $(".taxFormulaChargesGrid").load("/HotelTariff/GetTaxFormulaCharges", { TaxFormulaId: taxFormulaId, HotelTriffPriceDetailsId: hoteltriffpricedetailsid }, function () {
